...
<body>
<a href="#show-count" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-count" class="content scaffold-show" role="main">
    ...
    <g:form url="[resource: countInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${countInstance}"><g:message code="default.button.edit.label"
                                                                                      default="Edit"/></g:link>
